    ...
    >
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Share a read-only version of this lesson. The preview has no AI actions — anyone can study
          it, and learners keep their own scores.
        </p>
        ...
        {loading ? (
          ...
          <>
            <div className="mt-4 grid grid-cols-2 gap-2">
              {(
                ...
                >
                  ...
                  <div
                    className={`text-[11px] ${visibility === value ? "text-primary-foreground/80" : "text-muted-foreground"}`}
                  >
                    {hint}
                  </div>
                </button>
            ...
            <div className="mt-1 flex gap-2">
              ...
              <button
                onClick={copy}
                className="rounded-2xl bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground"
              >
                {copied ? "✅" : "Copy"}
              </button>
            </div>
